...
public class Order
{
    ...
    private final double COMPANY_TAX = 0.1;
    ...
    {
        this.grandTotal =
                this.subTotal + (this.subTotal * this.COMPANY_TAX);
    }
    ...
    public void displayOrder(String customerName)
    {
        ...
        System.out.printf("Price before tax: Rs.%.2f\n", subTotal);
    ...
    public void payForOrder()
    {
        ...
        while (grandTotal != 0.00)
        {
            ...
            System.out.printf("Your total is Rs.%.2f\n", grandTotal);
    ...
    private void calculateChange()
    {
        ...
        System.out.println("Your change is Rs." + changeDue);
    }
